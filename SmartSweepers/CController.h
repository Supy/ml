...
private:
	...
	vector<Genome> m_populationOfGenomes;
	...
	//Pointer to the Neuro Evolution Class
	CNeuroEvolution* m_NeuroEvolutionObject;

	int m_NumSweepers;
	int m_NumMines;
	int m_NumSuperMines;
	int m_NumRocks;
	int m_NumWeightsInANN;
	...
	// stores average RocksGathered per iteration for use in graphing
